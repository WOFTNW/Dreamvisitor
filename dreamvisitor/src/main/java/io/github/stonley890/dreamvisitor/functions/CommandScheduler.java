        ...
        if (!configFile.exists()) {
            try {
                if (configFile.createNewFile()) {
                    Dreamvisitor.getPlugin().getLogger().info(configFile.getName() + " was created.");
                }
            } catch (IOException e) {
                Dreamvisitor.getPlugin().getLogger().log(Level.SEVERE, "Could not create " + configFile.getName(), e);
                return;
            }
        }
        ...
        public boolean shouldRun(@NotNull LocalDateTime now) {
            switch (type) {
                ...
                case CRON:
                    ...
                    if (cronPattern == null) {
                        // Should not happen
                        throw new NullPointerException("Cron pattern for this schedule is null!");
                    }
        ...
        public String getTimeUntilNextRun() {
            ...
            switch (type) {
                ...
                case DAILY:
                    if (dailyTime == null) {
                        // Should not happen
                        throw new NullPointerException("Daily time for this schedule is null!");
                    }
        ...
        public String toString() {
            ...
            switch (type) {
                ...
                case CRON -> {
                    ...
                    sb.append(", pattern='").append(cronPattern.getPattern()).append("'");
                }
            }
