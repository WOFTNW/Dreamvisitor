...
public enum ConfigKey {
    ...
    FLIGHT_ENERGY_CAPACITY("flight_energy_capacity", 400.00, Double.class),
    ...
    FLIGHT_ENERGY_DEPLETION_X_Z_MULTIPLIER("flight_energy_depletion_x_z_multiplier", 1.00, Double.class),
    FLIGHT_ENERGY_DEPLETION_Y_MULTIPLIER("flight_energy_depletion_y_multiplier", 2.00, Double.class),
