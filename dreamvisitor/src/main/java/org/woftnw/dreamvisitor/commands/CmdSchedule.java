                ...
                .withSubcommands(
                        new CommandAPICommand("interval")
                                ...
                                .executesNative((sender, args) -> {
                                    ...
                                    final int intervalMinutes = (int) args.get("interval-minutes");
                                    final String commandInput = (String) args.get("command");
                        ...
                        new CommandAPICommand("daily")
                                ...
                                .executesNative((sender, args) -> {
                                    final String name = (String) args.get("name");
                                    final String timeString = (String) args.get("time");
                                    final String commandInput = (String) args.get("command");
                        ...
                        new CommandAPICommand("cron")
                                ...
                                .executesNative((sender, args) -> {
                                    final String name = (String) args.get("name");
                                    final String pattern = (String) args.get("pattern");
                                    final String commandInput = (String) args.get("command");
                                    ...
                                    final Schedule schedule = CommandScheduler.getInstance().addCronSchedule(name, pattern, commands);
                                    if (schedule == null) {
                        ...
                        new CommandAPICommand("list")
                                ...
                                .executesNative((sender, args) -> {
                                    final List<Schedule> schedules = CommandScheduler.getInstance().getSchedules();
                        ...
                        new CommandAPICommand("remove-command")
                                ...
                                .executesNative((sender, args) -> {
                                    final String name = (String) args.get("name");
                                    final int index = (int) args.get("index") - 1; // Convert to 0-based index
                        ...
                        new CommandAPICommand("add-delay")
                                ...
                                .executesNative((sender, args) -> {
                                    final String name = (String) args.get("name");
                                    final int index = (int) args.get("index") - 1; // Convert to 0-based index
                                    final int delayTicks = (int) args.get("delay-ticks");
